...
export default function AutismTestingSection() {
  ...
  const evaluationSteps = [
    ...
    },
    {
      ...
      desc: "Instead of rigid tests, we use structured play, puzzles, and natural conversations. This allows us to observe how your child communicates and connects in a safe, stress-free space.",
    },
    {
      icon: Award,
      phase: "Phase 3",
      title: "The Roadmap Meeting",
      desc: "We sit down together to review a complete, easy-to-read guide. You will walk away knowing exactly how to get support from schools, therapists, and doctors.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full grid lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-[#67E8D6] text-xs font-bold uppercase tracking-wider">
              ...
              Dallas Developmental Assessments
            </div>
            ...
            <p className="text-base sm:text-lg text-slate-300 max-w-xl font-normal leading-relaxed">
              ...
              comprehensive, deeply compassionate autism evaluations for
              children, teenagers, and families across Dallas.
            </p>
        ...
        <div className="bg-white border border-slate-200/80 rounded-[2.5rem] p-8 sm:p-12 shadow-sm grid md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7">
            <p className="text-slate-600 font-normal text-base leading-relaxed">
              At Ariad Psychological Services, we do not view autism as a
              problem to solve. We view it as a unique blueprint for how a
              person thinks, learns, and communicates. Finding the right answer
              brings real peace of mind and gives you the exact tools to help
              your child flourish in school and life.
            </p>
          </div>
        </div>
      </div>
          ...
          {[
            {
              ...
              desc: "We combine deep clinical knowledge with observation and parent storytelling. This ensures we understand your child's complete developmental growth, strengths, and struggles.",
            },
            {
              num: "02",
              title: "Trusted Neighborhood Doctors",
              desc: "Our licensed neighborhood experts specialize in young minds. We provide reliable answers you can trust implicitly, right here in the Dallas, Highland Park, and Oak Lawn areas.",
            },
            {
              num: "03",
              title: "A Custom Space for Your Child",
              desc: "No child fits perfectly into a template. We modify our space and testing style to make sure your child feels completely safe, calm, and relaxed throughout the day.",
            },
          ].map((card, index) => (
            <motion.div
              key={index}
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <h3 className="text-3xl sm:text-4xl font-bold tracking-tight leading-tight">
                A gentle and supportive testing experience
              </h3>
            ...
            <div className="lg:col-span-7 bg-[#012321] rounded-[2.5rem] p-8 sm:p-12 min-h-[320px] flex flex-col justify-between border border-white/5 relative shadow-inner">
              ...
              <div className="flex gap-2 mt-8 pt-4 border-t border-white/10 text-xs text-slate-400 font-medium">
                ...
                <span>Industry standard tools • Entirely confidential</span>
              </div>
            </div>
          </div>
        </div>
          ...
          {[
            {
              ...
              desc: "We understand that waiting for answers can feel stressful. We actively protect your peace of mind by offering flexible appointment slots to get you seen quickly.",
            },
            {
              icon: Users,
              title: "A Team Approach to Support",
              desc: "We gladly collaborate with your teachers, speech therapists, and pediatricians. This ensures everyone in your child's circle stays aligned on the final treatment plan.",
            },
            {
              icon: Sparkles,
      ...
      >
        <div className="bg-[#F3EFE9] rounded-[2.5rem] p-8 sm:p-16 border border-slate-200 grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-6 space-y-6">
            ...
            <p className="text-slate-600 font-normal text-base leading-relaxed">
              Autism evaluations are comprehensive processes that involve
              standard testing, observations, and deep report writing. We spell
              out our hours clearly so you can plan with confidence.
            </p>
            ...
            <div className="flex items-start gap-3 bg-white/60 p-4 rounded-xl border border-slate-300/50 text-xs text-slate-500 max-w-md">
              ...
              <span>
                Evaluations usually require between 8 to 12 hours total,
                depending on your child's age and specific clinical needs.
              </span>
            </div>
          </div>
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-sm text-slate-200">
                  <li className="flex items-center gap-2.5">
                    ...
                    Initial Consultation & Parent Intake
                  </li>
                  <li className="flex items-center gap-2.5">
                    <CheckCircle className="w-4 h-4 text-[#67E8D6] shrink-0" />
                    Direct Interaction & Specialized Observation Tasks
                  </li>
                  <li className="flex items-center gap-2.5">
                    <CheckCircle className="w-4 h-4 text-[#67E8D6] shrink-0" />
                    Personal Feedback Meeting & Actionable Results Guide
                  </li>
                </ul>
              </div>
        ...
        >
          <div className="relative z-10 max-w-2xl mx-auto space-y-6">
            ...
            <div className="pt-2">
              ...
              >
                Schedule Your Autism Assessment
